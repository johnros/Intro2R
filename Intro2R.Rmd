...
__Note__: The [readr](https://github.com/hadley/readr) package facilitates and accelerates data importing. This section should be updated to use it.
...
See how `summary()` behaves differently on different object classes:
```{r}
...
# Date handeling 
See the `lubridate` package and manual [here](http://cran.r-project.org/web/packages/lubridate/vignettes/lubridate.html).
