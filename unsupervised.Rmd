...
```{r SOM}
library(kohonen)
som.1 <- som(USArrests.1, grid = somgrid(5, 5, "hexagonal"))
...
Other implementations can be found in `som::som()` and `class::SOM()` but `kohonen` seems the most complete and well documented.
