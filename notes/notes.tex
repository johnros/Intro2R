...
Describing the data via it's joint distribution would be nice, but would require many samples if $X$ has a high dimension (by high we mean $p>3$!). For higher dimensions we need to set more modest goals.
