...
\end{align}
Assuming a generative distribution on $\varepsilon$, we may try to estimate $\loadings \latent$ by maximum likelihood.
...
\item[Loadings] The $A$ matrix; the contribution of each attributed to the observed $X$.
