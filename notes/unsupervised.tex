...
A class of greedy algorithms for two-class clustering. 
We stress that unlike k-means, the method is the algorithm itself and cannot be case as an optimization (ERM) problem.
