...
\item \textbf{Support}: The empirical probability of an event/item, $\supp{A}:=\sum \indicator{A \in \sample}/n$.
...
\item \textbf{Scree Plot}: A simple plot visualizing the eigen value versus the component's number. 
\end{itemize}
...
\id{Clustering}{Algorithm}{$X$}{Data Clustering, Visualization}{Dim. Reduce}{--}
