...
The different tasks in unsupervised learning are
\begin{enumerate}
...
Find a low dimensional representation of the joint distribution. This allows the learning from realistic sample sizes, and analysis by, e.g., interpretable parameters and visualization.
...
Dimensionality methods in particular serve to represent the data in a more compact way, thus alleviating the computational burden of supervised learning. 
