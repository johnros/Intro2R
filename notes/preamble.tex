...
\newcommand{\expect}[1]{\mathbf{E}\left[ \rv{#1} \right]} % The expectation operator
...
\newcommand{\estim}[1]{\hat{\rv{#1}}} % An estimator
...
\newcommand{\similarity}{d} % A similarity measure.
