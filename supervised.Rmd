...
# Smoothing Splines
I will demonstrate the method with a single predictor, so that we can visualize the smoothign that has been performed:
...
# Stacking
As seen in the class notes, there are many ensenble methods.
