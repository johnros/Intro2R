...
3. Plot a histogram and a boxplot of the delays of JetBlue Airways flights (`airlines` dataset). Now plot the same plots for each day of the week. Export the plots as pdf files.
